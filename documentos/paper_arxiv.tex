...
lattice~\cite{epstein1903, sarnak2006}, and through the
Friedli--Karlsson theorem~\cite{friedli2017}, to the Riemann
hypothesis.
...
(norm~$4$), and (v) connects to Epstein's zeta function and the
Riemann hypothesis. The collapse rate $\beta=(1-\eta)+\varepsilon_0/2$
is derived from the FCC packing fraction, closing the model entirely.
Five falsifiable experiments are proposed, realizable with existing
cold-atom platforms.
